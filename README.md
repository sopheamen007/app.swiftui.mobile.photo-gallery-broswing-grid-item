## Build a Photo Gallery Browsing Grid Item View in SwiftUI like Instagram and Facebook on IOS 17.0
...
![Video Player](https://github.com/user-attachments/assets/233c62ee-2827-4a7b-9e46-e15b364f54d0)

![Main Screen](https://github.com/user-attachments/assets/66ad2484-9d8a-4d6d-b099-a1d774dc76bb)

## Features

- **Custom Struct Grid Items Using Columns**: Design and implement custom grid items for a sleek photo gallery layout.
- **PHPhotoLibrary Permission Handling**: Check and manage photo library permissions using PHPhotoLibrary.
- **Loading Photos with PHFetchOptions**: Efficiently load and display photos from the user's library using PHFetchOptions and fetchAssets API.
...
1. **Clone the repository**:
   ...
   ```bash
   git clone https://github.com/sopheamen007/app.swiftui.mobile.photo-gallery-broswing-grid-item
   
2. **Open the project in Xcode**:

   ```bash
   cd app.swiftui.mobile.photo-gallery-broswing-grid-item
